...
<div id="WebPage">
  ...
  <title>Pedidos Pagados</title>
	...
	<div class="align">
<div class="content">
			<h1>Compras Pagados</h1>
			<p>
			Estimado usuario, aqui puede ver sus compras que usted a pagado anteriormente.
			</p>
...
.tg .tg-0lax{text-align:left;vertical-align:top}
   ...
   <?php
	...
	@$usuario = $sesion->get("email");
     ...
     $Consulta = "select * from ordencomprada where emailcomprador='$usuario' and estado='1'";
   ...
   <tbody>
     <tr>
       <td style="color: #4C697A;"><?php echo $ListPro['product_id']; ?></td>
       <td style="color: #4C697A; font-weight: normal;">Pagado</td>
       <td style="color: #4C697A; font-weight: normal;">$<?php echo $ListPro['preciototal']; ?></td>
	   <td style="display: none"><input type="hidden" name="uwuaa" class="casillas" size="15" readonly="readonly" value="<?php echo $ListPro['emailcomprador']; ?>"  /></td>
