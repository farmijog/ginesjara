...
$query = Select_Record_By_One_Filter($data, 'ordencomprada');
...
<form name="form"  class="form-horizontal" method="post" enctype="multipart/form-data" action="query_modestadov2.php">
<div class="row-fluid" id="products-columns">
		...
		<div class="panel panel-info">
		  ...
		  ?>
			...
			<p><input type="hidden" name="pretoto" value="<?php echo $result['preciototal'];;?>"></p>
