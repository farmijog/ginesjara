					...
					<h4 class="tabletitle"><span class="nombreTabla">Datos del Cliente</span></h4>
						...
						<div class="IntTable">
				            ...
				            <div class="control-group">
				              ...
				              <div class="controls">
				                <input type="text" id="cliente_nombres" name="cliente_nombres" placeholder="Ingrese su Nombre" class="span4 :required :only_on_blur" maxlength="10" value="">	<span class="help-inline">(*)</span> 				                
				              </div>
				            </div>	
							...
							<input type="hidden" id="userNumber" name="userNumber" maxlength="5" value="">			                
				              
							<input type="hidden" id="userTipo" name="userTipo" maxlength="5"  value="Normal"> 
							<input type="hidden" id="userVerifi" name="userVerifi" maxlength="5"  value="NO"> 
				...
				<div style="background: #dddddd; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px;" class="table-bordered">
					<div class="IntTable">
						...
						<div id="enviarbtn" class="control-group">
							...
							<center><h3 style="color:green" id="exito" name="exito"></h3></center>
						</div>
