...
<div id="WebPage">
  ...
  <title>Respuesta cotizacion</title>
	...
	<div class="align">
<div class="content">
			<h1>Respuesta cotizacion</h1>
			<p>
			Estimado usuario, aqui puede ver la respuesta que otorgo el administrador a su cotizacion
			</p>
...
.tg .tg-0lax{text-align:left;vertical-align:top}
   ...
   <?php
	...
	@$usuario = $sesion->get("email");
     ...
     $Consulta = "select * from respuestaorden where emailcotizador='$usuario' and estado='0'";
   ...
   <tbody>
     <tr>
	   ...
	   <td style=""><a href="processPAY.php?id=<?php echo base64_encode($ListPro['product_id']); ?>">Pagar</</a></td>
