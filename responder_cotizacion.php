...
<br><br>
        <!--         Tespuesta de la cotizacion      -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="txtnombre" class="form-control" value="" style="font-family: Noto Sans; width: 35%; font-size: 13px;">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="txtprecio" class="form-control" value="<?php echo $Registros['precio_total'];?>" style="font-family: Noto Sans; width: 25%; font-size: 13px;">
                  </div>
                </div>
